...
write.csv(lm_output, "results/aruRates-abundance-regressions.csv",
          row.names = F)
```
![Of the 45 species for which acoustic detection rates were regressed with abundance (from point count data), 39 species showed a positive slope.](figs/fig_aruRate_vs_abundance_regressions.png)
