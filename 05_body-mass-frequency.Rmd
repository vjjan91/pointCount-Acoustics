...
ggsave(fig_medFreq_bodyMass, filename = "figs/fig_medianPeakFreq_bodyMass.png", width = 14, height = 16, device = png(), units = "in", dpi = 300)
dev.off() 
```

![A significant negative correlation was seen between median peak frequency and body mass. In line with our expectation, larger-bodied species vocalize at lower frequencies compared to smaller-bodied species.](figs/fig_medianPeakFreq_bodyMass.png)  
